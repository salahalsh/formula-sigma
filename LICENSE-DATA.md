# Data license - FORMULA-Sigma retrospective case datasets
...
You are free to share and adapt this curated data, including for commercial
purposes, provided you give appropriate credit, link to the license, and
indicate if changes were made.

## Important provenance note

This CC-BY-4.0 license covers ONLY our curation of the data: the cleaning,
re-tabulation, factor/response coding, and provenance hashing performed in this
repository. It does NOT extend to the original publications from which the
underlying numerical values were extracted. Those values are reproduced from
...
- The harness SOURCE CODE (this is under the MIT license; see LICENSE).
- The FORMULA-Sigma platform engine (proprietary; not part of this release).
